...
(function(_context) {
    ...
    // +-------------------------------
    _context.drawutils.prototype.point = function( p, color, radius ) {
	//var radius = 3;
	if( !radius ) radius = 3;
	this.ctx.beginPath();
	this.ctx.arc( this.offset.x + p.x, this.offset.y + p.y, radius, 0, 2 * Math.PI, false );
	this.ctx.closePath();
    ...
    // +-------------------------------
    _context.drawutils.prototype.dot = function( p, color, radius ) {
	//var radius = 3;
	if( !radius ) radius = 3;
	this.ctx.beginPath();
	this.ctx.moveTo( this.offset.x + p.x, this.offset.y + p.y );
	this.ctx.lineTo( this.offset.x + p.x +1, this.offset.y + p.y +1 );
	this.ctx.closePath();
	this._fillOrDraw( color );
    };
	...
	this.ctx.beginPath();
	this.ctx.rect( this.offset.x + center.x-size/2.0, this.offset.y + center.y-size/2.0, size, size );
	this.ctx.closePath();
	this._fillOrDraw( color );
    };
